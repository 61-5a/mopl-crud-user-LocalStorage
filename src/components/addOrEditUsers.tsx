            ...
            {formData.photo ? (
              <>
                <div className="flex flex-col w-full h-32">
                  <div className="flex flex-col items-center justify-left z-2">
                    <div className={styles.uploded_img_outer}>
                      <img
                        src={formData.photo}
                        className={styles.uploded_img}
                        alt="image"
                        onClick={() => {
                      ...
                      <img
                        ...
                        className={styles.uploded_close_img}
                        alt="Close"
                      />
                    </div>
                  </div>
